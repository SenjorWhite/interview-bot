...
const Announcement = () => {
	...
	return (
		<Dialog open={open} onClose={() => {}}>
			<DialogTitle style={{ textAlign: 'center' }}>Discover Senjor Pai's Technology Showcase</DialogTitle>
			<DialogContent style={{ textAlign: 'justify', textIndent: '2em' }}>
				...
				<p>
					...
					of information contained may not be sufficient to handle all questions. Its primary purpose is to
					demonstrate how RAG technology answers fact-based questions in a contextually relevant manner and
					overcomes the illusion problem of generic responses from LLM. Please approach these questions with
